...
return()=>{
  document.body.classList.remove('no-scroll')
   ...
   function clickerClick(e:React.FormEvent){
    ...
    "  >
      <section className="ml-5 z-[100]">  <div className="flex px-3 py-3 backdrop-blur-sm  shadow-md bg-translucent sm:bg-transparent sm:shadow-none sm:backdrop-blur-none space-x-2 justify-end items-center font-bold lg:text-[20px] rounded-xl  ">
        ...
        <div className="sm:hidden pr-10  " >
          ...
          <button className="shadow-md bg-translucent backdrop-blur-xl top-3 flex flex-col justify-center items-center w-8 h-8 space-y-1 relative p-2  z-[9999] sm:hidden" onClick={clicker} >
  ...
  <span className={`block w-6 h-0.5 bg-pink  transition-transform ${isOpen ? '-rotate-45 -translate-y-1.5' : ''}`}></span>
         ...
         {isOpen && (
  <div className="fixed inset-0 bg-torqoise z-[1000] flex items-center justify-center ">
